...
public enum GenerateOrderStatusEnum {
    ...
    OPSSVC_CREATE_RECORD_ERR(2, "OPSSVC_CREATE_RECORD_ERR", GenerateOrderStatus.OPSSVC_CREATE_RECORD_ERR),
    STORAGESVC_STORE_BATTERIES_ERR(3, "STORAGESVC_STORE_BATTERIES_ERR", GenerateOrderStatus.STORAGESVC_STORE_BATTERIES_ERR),
    LABSVC_BACKLOG_ERR(4, "LABSVC_BACKLOG_ERR", GenerateOrderStatus.LABSVC_BACKLOG_ERR),
    SPECSVC_GENBATTERIES_ERR(5, "SPECSVC_GENBATTERIES_ERR", GenerateOrderStatus.SPECSVC_GENBATTERIES_ERR);

    private final int statusCode;
    private final String statusDescription;
    private final GenerateOrderStatus grpcStatus;

    GenerateOrderStatusEnum(int statusCode, String statusDescription, GenerateOrderStatus grpcStatus) {
